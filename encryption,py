...
def decrypt():
    ...
    if password == "1234":
        ...
        deco = base64_bytes.decode("ascii")
        Label(screen2, text="DEcrypt", font="arial", fg="white", bg="#00bd56").place(x=10, y=0)
        text2 = Text(screen2, font="Rpbote 10", bg="white", relief=GROOVE, bd=0)
        text2.place(x=10, y=40, width=380, height=150)
        text2.insert(END, deco)
    elif password == "":
...
def encrypt():
    ...
    if password =="1234":
        ...
        text2=Text(screen1,font="Robote 10",bg="white",relief=GROOVE,bd=0)
        text2.place(x=10,y=40,width=380,height=150)
...
def main_screen():
    ...
    Button(text="Dencrypt",height=2,width=23,bg="#00bd56",fg="white",bd=0,command=decrypt).place(x=200,y=250)
